...
docAGraf = "CALL apoc.mongo.find('mongodb://mong:27017/ghibli.movies', {}) YIELD value CALL apoc.graph.fromDocument(value, {write: true, idField: 'title' ,mappings: {`$`: 'Ghibli{*, @_id}',`$.character`: 'Character{!name,originalCast,lastEnglishDubbingActor}',`$.reviews`: 'Reviews{!rottenTomatoes, !imdb}' }}) YIELD graph AS g1 return g1"
